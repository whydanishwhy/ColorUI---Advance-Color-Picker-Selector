...
const Header: React.FC<HeaderProps> = ({ active,isActive, setIsActive, setActive, setSettingPage,SettingPage }) => {
...
useEffect(() => {
  ...
  return (
    ...
    style={{cursor:'pointer', border:'none'}} onClick={() => setSettingPage(false)} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M20 11H7.83L13.42 5.41L12 4L4 12L12 20L13.41 18.59L7.83 13H20V11Z" fill="#626262"/>
</svg>
:  
<div style={{color:'#1b1b1b', userSelect:'none'}}>
  .
</div>
...
zIndex={9999}   appendTo={(ref) => {
  ...
  <RotateCcw style={{cursor:'pointer'}} size={20} color="white" onClick={Reset}/>
  </Tippy>
...
className='buttons'  onClick={Close } 

style={{backgroundColor:isHovered2 ?'red' :'#383838', borderRadius:'50%',cursor:'pointer',transition:'0.4s ease-in-out', height:'20px', width:'20px'}}></div>
