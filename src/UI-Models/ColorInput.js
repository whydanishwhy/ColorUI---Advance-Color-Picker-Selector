 ...
 */
function getOrCreateOverlay(element) {
    // Check if overlay already exists
    const existing = element.querySelector(`[${OVERLAY_ATTR}]`);
    if (existing)
        return existing;
...
function removeOverlay(element) {
    const overlay = element.querySelector(`[${OVERLAY_ATTR}]`);
    if (overlay)
        overlay.remove();
...
const ColorInput = ({ element, mode, Bgcolor }) => {
    ...
    useEffect(() => {
        ...
        lastElementRef.current = element !== null && element !== void 0 ? element : null;
        if (!element) {
            setColor("#000000");
            setOverlayActive(false);
            return;
        ...
        const existingOverlay = element.querySelector(`[${OVERLAY_ATTR}]`);
    ...
    const handleChange = (value, fromText = false) => {
        if (!element)
            return;
        setColor(value);
        ...
        if (fromText) {
            ...
            if (!hex)
                return; // still mid-typing — update display only
            applyColor(hex);
        }
        else {
            applyColor(value);
    ...
    const showResetButton = mode === "backgroundColor"
        ? overlayActive
        : !!(element === null || element === void 0 ? void 0 : element.style.getPropertyValue(mode === "color"
            ? "color"
            : mode === "borderColor"
                ? "border-color"
                : mode === "shadowColor"
                    ? "box-shadow"
                    : "background"));
    const displayValue = (color === null || color === void 0 ? void 0 : color.includes("linear-gradient")) || (color === null || color === void 0 ? void 0 : color.includes("radial-gradient"))
        ? "Gradient"
        : color === "transparent"
            ? "transparent"
            : color;
    return (_jsxs("div", { style: {
            ...
            position: "relative",
                    ...
                    flexShrink: 0,
                            ...
                            pointerEvents: "none",
                        } }), _jsx("input", { type: "color", value: color.startsWith("#") ? color : "#000000", onChange: (e) => handleChange(e.target.value, false), style: {
                            position: "absolute",
                            inset: 0,
                            width: "100%",
                            height: "100%",
                            ...
                            padding: 0,
                            margin: 0,
                        } })] }), _jsx("input", { type: "text", value: displayValue, onChange: (e) => handleChange(e.target.value, true), onClick: (e) => e.currentTarget.select(), placeholder: "#000000", style: {
                    flex: 1,
                    minWidth: 0,
                    padding: "4px 2px",
                    border: "none",
                    ...
                    fontSize: "16px",
                    fontWeight: '600'
                } }), _jsx("button", { onClick: handleCopyColor, title: isCopied ? "Copied!" : "Copy color code", style: {
                    background: "none",
                    border: "none",
                    cursor: "pointer",
                    padding: "4px",
                ...
                _jsx("svg", { width: "14", height: "14", viewBox: "0 0 14 14", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: _jsx("path", { d: "M11.5 3.5L5.25 10.5L2.5 7.5", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }) })) : (
                // Copy icon - default state
                _jsxs("svg", { width: "14", height: "14", viewBox: "0 0 14 14", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [_jsx("path", { d: "M4.5 5.5H2.5C2.23478 5.5 1.98043 5.6054 1.79289 5.79289C1.6054 5.98043 1.5 6.23478 1.5 6.5V11.5C1.5 11.7652 1.6054 12.0196 1.79289 12.2071C1.98043 12.3946 2.23478 12.5 2.5 12.5H7.5C7.76522 12.5 8.01957 12.3946 8.20711 12.2071C8.3946 12.0196 8.5 11.7652 8.5 11.5V9.5", stroke: "currentColor", strokeWidth: "1.2", strokeLinecap: "round", strokeLinejoin: "round" }), _jsx("path", { d: "M9 2H11.5C11.7652 2 12.0196 2.10536 12.2071 2.29289C12.3946 2.48043 12.5 2.73478 12.5 3V8.5C12.5 8.76522 12.3946 9.01957 12.2071 9.20711C12.0196 9.3946 11.7652 9.5 11.5 9.5H9C8.73478 9.5 8.48043 9.3946 8.29289 9.20711C8.1054 9.01957 8 8.76522 8 8.5V3C8 2.73478 8.1054 2.48043 8.29289 2.29289C8.48043 2.10536 8.73478 2 9 2Z", stroke: "currentColor", strokeWidth: "1.2", strokeLinecap: "round", strokeLinejoin: "round" })] })) }), showResetButton && (_jsx("button", { onClick: handleReset, title: mode === "backgroundColor"
                ...
                }, onMouseEnter: (e) => (e.currentTarget.style.color = "#ff6b6b"), onMouseLeave: (e) => (e.currentTarget.style.color = "#888"), children: _jsxs("svg", { width: "12", height: "12", viewBox: "0 0 12 12", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [_jsx("circle", { cx: "6", cy: "6", r: "5.5", stroke: "currentColor", strokeWidth: "1" }), _jsx("path", { d: "M4 4L8 8M8 4L4 8", stroke: "currentColor", strokeWidth: "1.2", strokeLinecap: "round" })] }) }))] }));
};
