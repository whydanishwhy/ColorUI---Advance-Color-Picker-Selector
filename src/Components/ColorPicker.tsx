...
const ColorPicker: React.FC = () => {
  ...
  const PairingColors = (index: number) => {
    setHeights(prev => {
  ...
  return (
    <div>
        ...
        {colors.map((color, index) => (
          <div
            ...
            style={{
              ...
              position: 'relative',
              boxShadow:
                '0px 4px 4px rgba(0,0,0,0.25), inset 15px 12px 13.9px -1px rgba(0,0,0,0.35)',
              borderRadius: '8px',
            }}
          >
            <span
            ...
            >
              ...
              >
                {/* Pairing Colors button */}
                <div
                  className="hiddenOpacity"
                  onClick={() => PairingColors(index)}
                  style={{
              ...
              {/* Pairing content */}
              {heights[index] === '200px' && <div>Hello colors</div>}
            </span>
          </div>
        ))}
      </div>
      ...
      {/* Pick color button */}
      <button onClick={Pick} style={{ marginTop: '20px' }}>
        Pick Color
      </button>
    </div>
  );
