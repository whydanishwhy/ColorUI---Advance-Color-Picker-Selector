...
const hasText = (el) => { var _a, _b; return EDITABLE_TAGS.has(el.tagName) && ((_b = (_a = el.textContent) === null || _a === void 0 ? void 0 : _a.trim().length) !== null && _b !== void 0 ? _b : 0) > 0; };
...
// ─────────────────────────────────────────────
function positionToolbar(toolbar, target, containerEl) {
    ...
    const isSmall = rect.width < 120 || rect.height < 42;
    let top = 0;
    let left = 0;
    let placement;
    // ─────────────────────────────
    ...
    // ─────────────────────────────
        ...
        left =
            rect.left +
                rect.width / 2 -
                TOOLBAR_W / 2;
        left = Math.max(8, Math.min(left, vpW - TOOLBAR_W - SIDEBAR_W - 8));
    }
...
// ─────────────────────────────────────────────
function buildToolbar(target, onDeselect, onDelete, onEnterEdit, containerEl) {
    ...
    const actions = [
        {
            ...
            onClick: (el) => {
                ...
                const btn = toolbarEl === null || toolbarEl === void 0 ? void 0 : toolbarEl.querySelector(`[data-action="copy-style"]`);
                if (btn) {
        ...
        },
        {
            ...
            onClick: (el) => {
                ...
                const SAFE = ["color", "backgroundColor", "fontSize", "fontWeight", "fontFamily",
                    ...
                    "opacity", "boxShadow"];
                SAFE.forEach((p) => {
                    if (copiedStyles && copiedStyles[p]) {
            ...
            onClick: (el) => {
                ...
                input.onchange = () => {
                    ...
                    reader.onload = (ev) => {
                        var _a, _b;
                        if (el.tagName === "IMG") {
                            el.src = (_a = ev.target) === null || _a === void 0 ? void 0 : _a.result;
                        }
                        else {
                            el.style.backgroundImage = `url(${(_b = ev.target) === null || _b === void 0 ? void 0 : _b.result})`;
                        }
                    };
        ...
        { id: "divider-2", icon: "", label: "", onClick: () => { } },
        {
            ...
            onClick: (el) => {
                ...
                (_a = el.parentNode) === null || _a === void 0 ? void 0 : _a.insertBefore(clone, el.nextSibling);
            },
        },
        {
            id: "move-up",
            ...
            onClick: (el) => {
                var _a;
                (_a = el.previousElementSibling) === null || _a === void 0 ? void 0 : _a.before(el);
            },
        },
        {
            id: "move-down",
            ...
            onClick: (el) => {
                var _a;
                (_a = el.nextElementSibling) === null || _a === void 0 ? void 0 : _a.after(el);
            },
        },
...
const VisualEditPro = ({ isActive, setIsActive, isKeyValid, setSettingPage, handleAction }) => {
    ...
    // ─── Helpers ───────────────────────────────
    const cleanupEditMode = useCallback((el) => {
        if (!el)
            return;
    ...
    const cleanupSelection = useCallback((el) => {
        if (!el)
            return;
        el.style.outline = "";
    ...
    useEffect(() => {
        ...
        `;
            ...
            (_a = document.getElementById(styleId)) === null || _a === void 0 ? void 0 : _a.remove();
        }
        return () => { var _a; (_a = document.getElementById(styleId)) === null || _a === void 0 ? void 0 : _a.remove(); };
    }, [isActive]);
    // ─── Draggable ──────────────────────────────
    useEffect(() => {
        if (!element || !isActive)
        ...
        draggableRef.current = interact(element)
            ...
            listeners: {
                start(event) {
                    ...
                    if (host === null || host === void 0 ? void 0 : host.contains(target))
                        return;
                ...
                move(event) {
                    if (!isActiveRef.current)
                        return;
                    const target = event.target;
                    if ((host === null || host === void 0 ? void 0 : host.contains(target)) || editingElementRef.current)
                        return;
                    ...
                    setTimeout(() => {
                        ...
                        setIsDragging(false);
                        if (elementRef.current)
                            showToolbar(elementRef.current);
                    }, 160);
                },
            },
        })
        ...
        return () => {
            var _a;
            (_a = draggableRef.current) === null || _a === void 0 ? void 0 : _a.unset();
    ...
    useEffect(() => {
        ...
        const handleMouseDown = (e) => {
            ...
            const resolved = (_b = (_a = raw.closest("a")) !== null && _a !== void 0 ? _a : raw.closest("button")) !== null && _b !== void 0 ? _b : raw;
        ...
        const handleMouseMoveCapture = (e) => {
            ...
            if (dx > 4 || dy > 4)
                didDragClickRef.current = true;
        };
        // ── mouseup: commit selection ──
        const handleMouseUp = (e) => {
            if (!isActiveRef.current || !mousedownTargetRef.current)
                return;
            if (isEditorTarget(e)) {
        ...
        const handleDoubleClick = (e) => {
            ...
            if (!EDITABLE_TAGS.has(resolved.tagName))
                return;
            ...
            try {
                ...
                const range = (_d = (_c = document.caretRangeFromPoint) === null || _c === void 0 ? void 0 : _c.call(document, e.clientX, e.clientY)) !== null && _d !== void 0 ? _d : null;
                if (range && sel) {
                    sel.removeAllRanges();
                    sel.addRange(range);
                }
                    ...
                    sel === null || sel === void 0 ? void 0 : sel.addRange(fb);
                }
            }
            catch (_e) { }
        ...
        const handleOut = (e) => {
            ...
            if (!isActiveRef.current || isDraggingRef.current)
                return;
            const t = e.target;
            if (!t || (host === null || host === void 0 ? void 0 : host.contains(t)) || t.tagName === "BODY")
                return;
            if (t.id === "__vep_toolbar__" || ((_a = t.closest) === null || _a === void 0 ? void 0 : _a.call(t, "#__vep_toolbar__")))
                return;
            if (t !== elementRef.current && t !== editingElementRef.current) {
                t.style.outline = "";
