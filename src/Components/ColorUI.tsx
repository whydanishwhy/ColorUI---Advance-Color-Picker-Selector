...
const ColorUI :React.FC<Prop> =({element}) => {
    ...
    const drawnDivRef = useRef<HTMLDivElement | null>(null);
    ...
    useEffect(() => {
        ...
        const handleMouseDown = (e: MouseEvent) => {
          e.preventDefault()
          if ((e.target as HTMLElement).closest("__EXT_HOST__")) return;
        ...
        const handleMouseMove = (e: MouseEvent) => {
          e.preventDefault();
          if (!drawnDivRef.current || !startPosRef.current) return;
