...
export default function ParticleSpectrum() {
    ...
    useEffect(() => {
        ...
        function drawParticles() {
            ...
            for (let i = 0; i < count; i++) {
                ...
                const wob = Math.sin(p.life * p.wobFreq + p.wobOff) *
                    p.wobAmp;
                ...
                ctx.globalAlpha = alpha;
                ctx.fillStyle = lerpColor(PARTICLE_COLOR_A, PARTICLE_COLOR_B, t);
        ...
        function drawSourceGlow() {
            ...
            g.addColorStop(0, `rgba(0,230,255,${SOURCE_GLOW_POWER})`);
    ...
    return (_jsxs("div", { style: { width: 270, padding: 20, fontFamily: "Arial" }, children: [_jsx("canvas", { ref: canvasRef, style: {
                    width: "100%",
                    display: "block",
                    ...
                    gap: 18,
                    marginTop: 18,
                }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 12 }, children: [_jsx("span", { style: { width: 80, color: "#7cecff", fontSize: 12 }, children: "Spread" }), _jsx("input", { type: "range", min: 0, max: 1, step: 0.01, value: spread, onChange: (e) => {
                                    const v = Number(e.target.value);
                                    setSpread(v);
                                    spreadRef.current = v;
                                }, style: { flex: 1 } }), _jsx("span", { style: { width: 40, color: "#7cecff", textAlign: "right" }, children: spread })] }), _jsxs("div", { style: { display: "flex", alignItems: "center", gap: 12 }, children: [_jsx("span", { style: { width: 80, color: "#7cecff", fontSize: 12 }, children: "Intensity" }), _jsx("input", { type: "range", min: 1, max: 100, value: intensity, onChange: (e) => {
                                    const v = Number(e.target.value);
                                    setIntensity(v);
                                    intensityRef.current = v;
                                }, style: { flex: 1 } }), _jsx("span", { style: { width: 40, color: "#7cecff", textAlign: "right" }, children: intensity })] })] })] }));
}
